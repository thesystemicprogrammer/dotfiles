...
which_key.register({
	...
	n = {
		...
		w = { "<cmd>Neorg workspace<cr>", "Workspace" },
	},
	p = {
		name = "Packer",
	...
	t = {
		...
		b = {
			...
			d = { "<cmd>BrowseDevdocsSearch<cr>", "Devdocs Search" },
			f = { "<cmd>BrowseDevdocsFiletypeSearch<cr>", "Devdocs Filetype Search" },
			m = { "<cmd>BrowseMdnSearch<cr>", "MDN Search" },
			o = { "<cmd>BrowseBookmarks<cr>", "Bookmarks" },
			s = { "<cmd>BrowseInputSearch<cr>", "Search" },
		},
	},
	x = {
		name = "Trouble",
